...
```{r}
## plot expression for the 10 highest scoring brain structures in age category 3 (children, 3-11 yrs)
## without dendrogram
...
names(genes) = c('ENSG00000168036', 'ENSG00000157764', 'ENSG00000163041', 'ENSG00000182158',
 'ENSG00000147889', 'ENSG00000103126', 'ENSG00000182054', 'ENSG00000184634', 
 'ENSG00000134982', 'ENSG00000138413', 'ENSG00000133703', 'ENSG00000132475')
genes
```
```{r,results='hide'} 
## run enrichment analysis
...
```{r}
## plot expression of the 5 brain strcutures with the lowest FWERs 
## genes ordered by user defined score from Wilcoxon rank test
